...
//The following are if/else statements that will display in the console log.  The innerHTML makes it display on the page

if (month >= 500) {
	result.html ("Wowwee!  That is a lot!");
	console.log("Wowwee!  That is a lot!");
} else {
	result.html ("You'll be broke!  You better ask Captain von Trapp for a raise.");
